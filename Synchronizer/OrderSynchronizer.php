...
class OrderSynchronizer extends Synchronizer
{
    ...
    public function syncOrder($order, $flush = true)
    {
        ...
        $entity
            ...
            ->setGiftCertificateAmount($order->giftCertificateAmount ? : null)
            ->setGiftCertificateNumber($order->giftCertificateNumber ? : null)
            ->setIncomplete($order->incomplete ? : null)
            ->setIp($order->ip ? : null)
            ->setModified($order->modified ? : null)
            ...
            ->setSalesDiscount($order->salesDiscount ? : null)
            ->setTotalPrice($order->totalPrice ? : null)
            ->setTotalWeight($order->totalWeight ? : null)
            ->setTrackingNumber($order->trackingNumber ? : null)
            ->setTransactionNumber($order->transactionNumber ? : null)
            ->setVatPct($order->vatPct ? : null)
            ->setVatRegNumber($order->vatRegNumber ? : null)
            ->setXmlParams($order->xmlParams ? : null)
            ->setShippingMethodFee($order->shippingInfo->fee ? : null)
        ;
